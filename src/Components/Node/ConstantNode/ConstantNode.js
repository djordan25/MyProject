...
import classes from './ConstantNode.module.scss';
...
class ConstantNode extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selected: false
        ...
        <Draggable
          ...
          <section className={nodeClass.join(' ')} style={{ zIndex: 1010 }}>
            ...
            <div className={classes.nodeContent}>
              ...
              {/* <input type="number" value={this.state.nodeValue} disabled /> */}
...
export default onClickOutside(ConstantNode);